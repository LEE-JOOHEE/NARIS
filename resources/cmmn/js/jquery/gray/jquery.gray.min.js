...
(function($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        extractUrl: function(backgroundImage) {
            ...
            startRegex = /^url\(["']?/;
            endRegex = /["']?\)$/;
            url = backgroundImage.replace(startRegex, "").replace(endRegex, "");
            return url
        },
        ...
        getBgSize: function(url, backgroundSize) {
            var img, ratio, defaultW, w, defaultH, h, size;
            img = new Image;
            img.src = url;
